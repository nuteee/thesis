...
\begin{figure}[ht]
\centerline{
\includegraphics[width=3.6in]{img/mavenlogo}}
...
\item tiszta és egyértelmű leírás legyen a projekt tartalmát tekintve,
\item könnyen lehessen a projekt információit megosztani,
\item és hogy több projekten keresztül tudjunk JAR fájlokat megosztani.
\end{itemize}

Az eredmény végül egy olyan eszköz lett, mellyel bármely Java alapú projektet tudjuk buildelni és kezelni.

A Maven első számú célja az, hogy lehetővé tegye a fejlesztő számára, hogy a lehető legrövidebb idő alatt megértse a fejlesztés szükségleteinek a teljes állapotát \cite{aboutmaven}. 
