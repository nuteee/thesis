...
\begin{figure}[ht]
\centerline{
\includegraphics[width=5.3in]{img/smartcitylogo}}
...
A Cop Controller a Robocar World Championship-hez készült megjelenítő, és egyben irányító program is. A program egy Maven (\ref{maven}. fejezet) alapú Java (\ref{java}. fejezet) projekt, melynek a grafikus felhasználói felülete a Swing (\ref{swing}. fejezet), és a JXMapViewer (\ref{jxmapviewer}. fejezet) segítségével valósult meg. 
...
\begin{figure}[h]
\centering
\subfigure{\includegraphics[width=5in]{img/oldworcester}\label{oldworcester}}
\quad
\subfigure{\includegraphics[width=5in]{img/newworcester}\label{newworcester}}
